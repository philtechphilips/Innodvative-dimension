...
@section('content')
    <section class="md:px-24 px-5 relative w-full h-screen flex flex-col justify-center"
        ...
        <div class="md:w-[500px] z-10">
            ...
            <p data-aos="fade-up" data-aos-duration="1000"
                class="tet-white text-center md:text-left font-medium text-white mt-8 mb-6">Experience the freshness of farm
                produce delivered straight
    ...
    <section id="about" class="md:px-24 px-5 w-full py-28 bg-slate-50 flex flex-col md:flex-row gap-16">
        ...
        <div class="md:w-1/2">
            ...
            <img data-aos="fade-up" data-aos-duration="1000" src="{{ asset('images/about-image.jpg') }}" class="mt-10"
                alt="">
        </div>
    </section>
    ...
    <section class="md:px-24 px-5 w-full flex flex-col justify-center h-96 relative overflow-hidden"
        ...
        <h1 data-aos="fade-up" data-aos-duration="1000"
            class="tex-xl text-white font-bold text-5xl z-10 md:text-left text-center">Our Vision</h1>
        <p data-aos="fade-up" data-aos-duration="1000"
            class="text-white text-lg z-10 md:w-[600px] mt-6 md:text-left text-center">To be a global leader in agriculture
            and natural health, setting
